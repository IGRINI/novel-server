...
type GameStateSummaryDTO struct {
	...
	SceneIndex          int       `json:"sceneIndex"`                    // Index of the current scene for this save
	CurrentSceneSummary *string   `json:"currentSceneSummary,omitempty"` // Summary of the current scene (from player_progress)
