...
func (_m *StoryConfigRepository) FindGeneratingOlderThan(ctx context.Context, threshold time.Time) ([]*sharedmodels.StoryConfig, error) {
	...
	var r0 []*sharedmodels.StoryConfig
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, time.Time) ([]*sharedmodels.StoryConfig, error)); ok {
		return rf(ctx, threshold)
	}
	if rf, ok := ret.Get(0).(func(context.Context, time.Time) []*sharedmodels.StoryConfig); ok {
		r0 = rf(ctx, threshold)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*sharedmodels.StoryConfig)
